...
if (isset($_POST['submit'])) {
  $reveiw_name = $_POST['name'];
  $reveiw_email = $_POST['email'];
  $reveiw_number = $_POST['number'];
  $reveiw_message = $_POST['message'];

  $select_review = mysqli_query($con, "SELECT * FROM `comment` WHERE name ='$reveiw_name'");



    $insert_reveiw = mysqli_query($con, "INSERT INTO `comment`(`name`, `number`, `email`, `review`) VALUES ('$reveiw_name','$reveiw_number','$reveiw_email','$reveiw_message')");
  
}
// Write the SQL query to select the reviews
...
<body>
  ...
  <div class="product_image_area section_padding">
    <div class="container">
      ...
      <?php
      echo '<div class="row s_product_inner justify-content-between">';
      echo '<div class="col-lg-7 col-xl-7">';
      echo '<div class="product_slider_img">';
      echo '<div id="vertical">';
      echo '<div data-thumb="">';
      echo '<img src="data:image/jpeg;base64,' . base64_encode($image) . '" alt="User Image" >';
      echo '</div>';
      echo '</div>';
      echo '</div>';
      echo '</div>';
            ...
            <div class="col-lg-6">
              <div class="review_box">
                ...
                <form class="row contact_form" action="#" method="POST" novalidate="novalidate">
                  ...
                  <div class="col-md-12 text-right">
                    <input type="submit" value="submit" name="submit" class="btn_3">
